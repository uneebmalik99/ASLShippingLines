...
const result = item.message.replace(regex, '');
        return (
            ...
            style={{margin:5, backgroundColor:'#F5F5F5',borderWidth:0.5,borderColor:'#E8E8E8', borderRadius:10, padding:2}}
                onPress={() => this.props.navigation.navigate('Notificationsdetails', { 'itemObj': item , 'result':result})}
                >
                <Elavation
                    elevation={1}
                    ...
                    <View style={{ flex: 1, padding: 5, marginLeft: 5, marginRight: 5 }}>
                        ...
                        <Text style={{ color: AppColors.textColor, fontSize: 12, marginTop: 9 }}>Date: {item.created_at}</Text>
                        {/* <TouchableOpacity>
